...
public class Video_Publication_Adapter_Main_Screen extends RecyclerView.Adapter<Video_Publication_Adapter_Main_Screen.PublicationViewHolder> {

    private List<Video_Publication_Main_Screen> items;
    protected static int click = 0;


    public static class PublicationViewHolder extends RecyclerView.ViewHolder {

        public VideoView PublicationVid;
        ...
        public PublicationViewHolder(View v) {
            ...
            PublicationVid = (VideoView) v.findViewById(R.id.VidPublcationS);
            ...
            //PublicationVid.start();
            PublicationVid.setMediaController(new MediaController(v.getContext()));
            PublicationVid.requestFocus();
            PublicationVid.canPause();
            PublicationVid.canSeekBackward();
            PublicationVid.canSeekForward();

        }
    }

    public Video_Publication_Adapter_Main_Screen(List<Video_Publication_Main_Screen> items) {
        this.items = items;
    }
    ...
    public PublicationViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.video_publication_card, viewGroup, false);
    ...
    public void onBindViewHolder(PublicationViewHolder viewHolder, int i) {
        ...
        viewHolder.PublicationVid.setVideoURI(Uri.parse(items.get(i).getPublicationVid()));
